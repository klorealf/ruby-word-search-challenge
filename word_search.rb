...
def straight_line_include?(word, puzzle)
 puzzle = [
  ...
  diagonal2 = puzzle[1][0] + puzzle[0][1]
  diagonal3 = puzzle[2][0] + puzzle[1][1] + puzzle[0][2]
  diagonal4 = puzzle[3][0] + puzzle[2][1] + puzzle[1][2] + puzzle[0][3]
  diagonal5 = puzzle[4][0] + puzzle[3][1] + puzzle[2][2] + puzzle[1][3] + puzzle[0][4]
  diagonal6 = puzzle[5][0] + puzzle[4][1] + puzzle[3][2] + puzzle[2][3] + puzzle[1][4] + puzzle[0][5]
  diagonal7 = puzzle[6][0] + puzzle[5][1] + puzzle[4][2] + puzzle[3][3] + puzzle[2][4] + puzzle[1][5] + puzzle[0][6]
  diagonal8 = puzzle[6][0] + puzzle[6][1] + puzzle[5][2] + puzzle[4][3] + puzzle[3][4] + puzzle[2][5] + puzzle[0][6]
  diagonal9 = puzzle[6][1] + puzzle[5][2] + puzzle[4][3] + puzzle[3][4] + puzzle[2][5] + puzzle[1][6]
  diagonal10 = puzzle[6][2] + puzzle[5][3] + puzzle[4][4] + puzzle[3][5] + puzzle[2][6]
  diagonal11 = puzzle[6][3] + puzzle[5][4] + puzzle[4][5] + puzzle[3][6]
  diagonal12 = puzzle[6][4] + puzzle[5][5] + puzzle[4][6]
  diagonal13 = puzzle[6][5] + puzzle[6][4]
